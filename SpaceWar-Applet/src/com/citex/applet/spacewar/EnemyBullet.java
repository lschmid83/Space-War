...
public class EnemyBullet extends Sprite {
     ...
     */
	public EnemyBullet(int type, int x, int y, boolean sine)
	{
		mType = type;
		mStrength = 1;
		mX = x;
    ...
    {
    	if(mType == 1)
    		return new Rectangle((int)mX + 22, (int)mY + 15, 11, 5);
    	else if(mType == 2)
    		return new Rectangle((int)mX + 22, (int)mY + 4, 11, 26);	
    	else if(mType == 3)
    		return new Rectangle((int)mX + 18, (int)mY + 6, 15, 21);	
    	else
